...
def consulta_por_folio():
    while True:
        try:
            ...
            if nota_encontrada and 'cancelada' not in nota_encontrada:
                print("\nNota encontrada:")
...
def consulta_por_cliente():
    ...
    while True:
        try:
            ...
            notas_cliente = [nota for nota in notas if nota['rfc'] == rfc_seleccionado and 'cancelada' not in nota]
